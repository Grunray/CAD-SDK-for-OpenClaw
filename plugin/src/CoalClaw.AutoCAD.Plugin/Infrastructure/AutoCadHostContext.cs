...
using CoalClaw.AutoCAD.Plugin.Services;

namespace CoalClaw.AutoCAD.Plugin.Infrastructure;

public sealed class AutoCadHostContext : ICadHostContext
{
    public const string ApiThreadingVersion = "threadfix-v5";
